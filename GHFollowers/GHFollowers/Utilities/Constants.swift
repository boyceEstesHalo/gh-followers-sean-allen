...
enum SFSymbols {
    ...
    static let gists = UIImage(systemName: "text.aligneft")
...
enum Images {
    ...
    static let ghLogo = UIImage(named: "gh-logo") // do not force unwrap images
}
...
enum DeviceType {
    ...
    // if iphone8 is in zoomed mode, it is basically iPhoneSE
